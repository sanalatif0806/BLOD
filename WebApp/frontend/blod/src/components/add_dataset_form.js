  ...
  const dataset_id = queryParams.get('dataset_id');
    ...
    if (dataset_id) {
      const fetchDataset = async () => {
        try {
          const response = await fetch(`${base_url}/BLOD/dataset_metadata/${dataset_id}`);
    ...
    <div className="container mt-3">
      ...
      {submitted && (
        <div className="alert alert-success" role="alert">
          {dataset_id ? (
            <>
              Your request to update <strong>{dataset_id}</strong> in the BLOD Cloud has been sent successfully, check the GitHub repository for updates:{' '}
              <a href="https://github.com/sanalatif0806/BLOD" target="_blank" rel="noopener noreferrer">
                https://github.com/sanalatif0806/BLOD
              </a>
            </>
          ) : (
            <>
              Your request to insert a new resource in the BLOD Cloud has been sent successfully, check the GitHub repository for updates:{' '}
              <a href="https://github.com/sanalatif0806/BLOD" target="_blank" rel="noopener noreferrer">
                https://github.com/sanalatif0806/BLOD
              </a>
            </>
